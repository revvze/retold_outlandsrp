...
hook.Add("Initialize", "ixAmmoMolotov", function()
	game.AddAmmoType({
		name = "molotov"
	})
end)
...
SWEP.ViewModelOffset = Vector(15, 30, -10)
...
function SWEP:ProjectileFire()
	...
	timer.Simple(0.2, function()
		...
		for i = 1, 48 do
			...
			molotovfire:SetPos(pos + Vector(math.Rand(-128, 128), math.Rand(-128, 128), 0))
			molotovfire:SetKeyValue("firesize", "60")
			molotovfire:SetKeyValue("damagescale", "10")
