...
sound.Add({
    name = "ixPulseShotgun.Fire",
    channel = CHAN_WEAPON,
    volume = 1.0,
    level = 80,
    pitch = {95, 110},
    sound = {
        "interlock/player/weapons/combine_shotgun/fire01.wav",
        "interlock/player/weapons/combine_shotgun/fire02.wav",
        "interlock/player/weapons/combine_shotgun/fire03.wav",
        "interlock/player/weapons/combine_shotgun/fire04.wav",
    },
})
...
SWEP.ViewModelOffset = Vector(3, 0, -2)

SWEP.IronsightsPos = Vector(-4, 5, 1)
SWEP.IronsightsAng = Angle(2, 2.5, 0)
...
SWEP.WElements = {
    ["shotgun"] = { type = "Model", model = "models/weapons/w_heavyshotgun.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(9, 1.187, -1.696), angle = Angle(-180, -90, 10.798), size = Vector(1, 1.5, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
