...
net.Receive("ixDispatchSend", function()
    chat.AddText(Color(255, 40, 40), "Overwatch broadcasts: "..net.ReadString())
end)

surface.CreateFont("CombineHudFontBig", {
	font = "Consolas",
	size = 25,
	scanlines = 2,
})

surface.CreateFont("CombineHudFontMedium", {
	font = "Consolas",
	size = 20,
	scanlines = 2,
})

surface.CreateFont("CombineHudFontSmall", {
	font = "Consolas",
	size = 15,
	scanlines = 2,
})
