        ...
        for k, v in pairs(drawInfo) do
            ...
            if (IsValid(entity)) then
                ...
                if ( entity.UIName ) then
                    ...
                    if ( descriptionText != "" and entity.UIDesc ) then
                        ix.util.DrawText(descriptionText or "", x, y+descHeight-(genericHeight/2), ColorAlpha(color_white, v.alpha*255), 1, 1, "Font-Elements17")
                    end
                ...
                if (entity:IsPlayer()) then
                    ...
                    if (character) then
                        ...
                        if ( entity:IsConscript() ) then
                            if ( character:GetClass() == CLASS_CONSCRIPT_R ) then
                                ix.util.DrawText("Rebel", x, y+(descHeight)-(genericHeight/2), ColorAlpha(Color(230,180,0), v.alpha*255), 1, 1, "ixItemDescFont")
                                y = y - descHeight
                            elseif ( character:GetClass() == CLASS_CONSCRIPT_C ) then
                                ix.util.DrawText("Combine", x, y+(descHeight)-(genericHeight/2), ColorAlpha(Color(230,180,0), v.alpha*255), 1, 1, "ixItemDescFont")
                                y = y - descHeight
                            end
                        end
