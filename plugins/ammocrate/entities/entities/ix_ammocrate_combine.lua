...
if ( SERVER ) then
    ...
    function ENT:Use(ply)
        if ( IsValid(self) ) then
            ...
            if ( ( ply:IsConscript() and ply:GetCharacter():GetClass() == CLASS_CONSCRIPT_C ) or ply:IsCombine() ) then
                ...
                if ( ply:IsConscript() and ply:GetCharacter():GetClass() == CLASS_CONSCRIPT_R ) then
                    ply:Notify("You need to be a Conscript which is affiliated to the Combine to use this.")
                else
                    ply:Notify("You need to be a Combine or a Combine Conscript to use this.")
                end
            end
