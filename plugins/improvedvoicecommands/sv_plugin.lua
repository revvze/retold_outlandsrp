...
function Schema:PlayerMessageSend(speaker, chatType, text, anonymous, receivers, rawText)
	...
	if chatType == "ic" or chatType == "w" or chatType == "y" or chatType == "dispatch" or (ix.config.Get("radioVCAllow", true) and Schema.voices.radioTypes[chatType]) then
            ...
            for k2, v2 in ipairs(texts) do
                ...
                if k2 == #texts then
                    ...
                    if speaker:IsCombine() and !isGlobal then
                        ...
                        if ( speaker:IsOW() ) then
                            table.insert(sounds, "NPC_Combine.Radio.Off")
                        else
                    ...
                    if Schema.voices.radioTypes[chatType] then
        ...
        if speaker:IsCombine() then
            if not ( Schema.voices.radioTypes[chatType] ) then
